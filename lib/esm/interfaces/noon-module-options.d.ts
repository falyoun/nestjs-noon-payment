...
export declare type NoonModuleOptions = {
    noonApiKey: string;
...
export interface NoonModuleAsyncOptions extends Pick<ModuleMetadata, 'imports'> {
    useExisting?: Type<NoonModuleOptionsFactory>;
    useClass?: Type<NoonModuleOptionsFactory>;
    useFactory?: (...args: any[]) => Promise<NoonModuleOptions> | NoonModuleOptions;
    inject?: any[];
