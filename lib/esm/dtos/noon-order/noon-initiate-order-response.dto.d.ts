import { NoonBusinessDto, NoonCheckoutDataDto, NoonDeviceFingerPrintDto, NoonFraudCheckDto, NoonOrderDto, NoonOrderConfigurationsDto, NoonPayerAuthenticationDto, NoonPaymentDetailsDto, NoonRequestAuthenticationDto } from '@app/dtos';
export declare class NoonInitiateOrderResponseDto {
    resultCode: number;
    message: string;
    resultClass: number;
